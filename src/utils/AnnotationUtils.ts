...
const messages: Record<
  ...
  Record<string, Partial<Record<MinimalUserLocale, string>>>
> = {
  112: {
    // Albopictus
    true: {
      [MinimalUserLocale.Es]:
