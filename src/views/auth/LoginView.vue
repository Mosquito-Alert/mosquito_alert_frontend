<template>
  ...
  <div class="px-8 min-h-screen flex justify-center items-center">
    <div
      class="rounded-4xl border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded z-10"
    >
      <div
        class="flex flex-col w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 items-center"
        style="border-radius: 53px"
      >
        <div class="text-center mb-8">
          <img src="/logo.png" alt="Mosquito Alert Logo" class="mb-6 w-32 shrink-0 mx-auto" />
          <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">
            Welcome to Mosquito Alert
          </div>
